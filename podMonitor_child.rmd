...
if(month(startdate)==month(now())){
  ...
  summary_text<-glue("{counts$lastSent} pods have been sent and {counts$lastNotSent} have not, equating to an additional {0.5*counts$lastNotSent} patient hours spent in BRI ED.")
}else{
